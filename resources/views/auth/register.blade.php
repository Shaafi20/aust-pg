            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default modal-content" style="margin-bottom: 8px;">
                        <div class="panel-title text-center" >
                                ...
                                <h2 class="title" style="font-size: 42px;">Sign Up</h2>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="form-control">
                                        ...
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"
                                            ...
                                            <input type="text" class="form-control" name="student_id" id="student_id"
                                                   placeholder="Enter your AUST student ID" value="{{ old('student_id') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    <label for="phone" class="control-label">Phone Number (Format: 01XXXXXXXXX)</label>
                                    ...
                                    <div class="form-control">
                                        ...
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"
                                            ...
                                            <input type="text" class="form-control" name="phone" id="phone"
                                                   placeholder="Enter your active phone number" value="{{ old('phone') }}" required>
                                        </div>
                                    </div>
                                </div>
